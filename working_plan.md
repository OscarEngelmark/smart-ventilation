...
|---|---|---|---|
| 4 | Room time faster than real time (`project_notes.md` §6) | how much faster; the shared clock both simulators compute room time from; which intervals count in room time (the sensors' too, so speed doesn't change how often they sample) | 2 |
