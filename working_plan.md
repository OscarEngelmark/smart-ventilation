...
|---|---|---|---|
| 4 | Room time at a chosen speed, in sessions (`project_notes.md` §6): every service switched to the clock in `internal/roomtime` | which intervals count in room time (the sensors' too, so speed doesn't change how often they sample) | 1 |
