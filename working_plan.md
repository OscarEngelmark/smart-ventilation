...
|---|---|---|---|
| 7 | Decision service (Go): plans the damper level from the occupancy forecast and the room model, keeps CO2 under 1000 ppm, commands the actuator (`project_notes.md` §7, *the system pursues three goals*) | how the reactive mechanism keeps CO2 under 1000 ppm when occupancy is unexpected; behavior when the forecast or room model is missing or stale, including before enough history exists | 2 |
